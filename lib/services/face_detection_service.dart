...
class FaceDetectionService extends ChangeNotifier {
  ...
  final _faceDetectorOptions = FaceDetectorOptions(
    ...
    enableClassification: true, // zusätzliche Klassifikationen: z.B. Lächeln, Augen offen
  );
  ...
  Future<void> _processImage(CameraImage image) async {
    try {
      ...
      if (inputImage == null) {
        SnackBarService.showMessage("Fehler bei der Umwandlung des Bildformates (${InputImageFormatValue.fromRawValue(image.format.raw)})");
        return;
      }
  ...
  InputImage? _inputImageFromCameraImage(CameraImage image) {
    ...
    if (Platform.isIOS) {
      ...
      _orientations[_cameraService.cameraController.value.deviceOrientation];
